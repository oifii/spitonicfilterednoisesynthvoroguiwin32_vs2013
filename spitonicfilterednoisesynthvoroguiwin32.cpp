...
#include "stdafx.h"
#include "spitonicfilterednoisesynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicfilterednoisesynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicfilterednoisesynthvoroguiwin32class"};				// the main window class name
